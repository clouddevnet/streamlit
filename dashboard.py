            ...
            if spdr_sector in options:
                ...
                if timing == "Hourly":
                    ...
                    #st.write(stock)
                        ...
                        with col3:
                            st.image(f"https://charts-node.finviz.com/chart.ashx?cs=l&t={stock}&tf=h&s=linear&ct=candle_stick&tm=d&o[0][ot]=ema&o[0][op]=65&o[0][oc]=FF0000&o[1][ot]=ema&o[1][op]=15&o[1][oc]=0077B6&o[2][ot]=ema&o[2][op]=30&o[2][oc]=00FF00")
