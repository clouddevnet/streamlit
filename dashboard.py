...
if option == "Daily_review":
    ...
    SPDR = {
        'SPY' : ['SPY', 'QQQ', 'DIA', 'IWO', 'MDY', 'VTI', 'XLG', 'RSP', 'QQQE', 'XLK', 'SMH', 'IGV', 'CIBR', 'SKYY', 'AIQ', 'ARKK', 'FFTY', 'IBIT', 'VGT', 'SDS', 'XLC', 'XLY', 'XLP', 'XLF', 'XLV', 'XLI', 'XLE', 'XLB', 'XLU', 'XLRE', 'XOP', 'XHB', 'XME', 'XBI', 'KRE', 'IBB', 'XRT', 'TAN', 'PAVE', 'JETS',
                   'AAPL', 'AMZN', 'MSFT', 'GOOGL', 'META', 'NVDA', 'AMD', 'COST', 'TSLA', 'NFLX', 'AVGO', 'TSM', 'ANET', 'PANW', 'CRWD', 'PLTR', 'NOW', 'COIN', 'MSTR', 'MARA'],
                ...
                if timing == "Multi":
                    ...
                    for stock in symbols:
                        with col1:
                            st.image(f"https://charts-node.finviz.com/chart.ashx?cs=l&t={stock}&tf=h2&s=linear&ct=candle_stick&tm=d&o[0][ot]=sma&o[0][op]=50&o[0][oc]=FF0000&o[1][ot]=ema&o[1][op]=10&o[1][oc]=0077B6&o[2][ot]=ema&o[2][op]=21&o[2][oc]=00FF00")
                        with col2:
                            st.image(f"https://charts-node.finviz.com/chart.ashx?cs=l&t={stock}&tf=i30&s=linear&ct=candle_stick&tm=d&o[0][ot]=sma&o[0][op]=50&o[0][oc]=FF0000&o[1][ot]=ema&o[1][op]=10&o[1][oc]=0077B6&o[2][ot]=ema&o[2][op]=21&o[2][oc]=00FF00")
